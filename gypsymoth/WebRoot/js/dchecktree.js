...
dTree.prototype.node = function(node, nodeId) {
	...
	if(this.config.useCheckBox && nodeId!=0){
		...
		//alert("2-this.parEnum====="+this.parEnum);
		str += '<input type="checkbox" name="id" id="operation_c'+this.parEnum+'" onClick="caBox(\''+this.formId+'\',\'operation_c'+this.parEnum+'\')" value="' + node.id +'" class="cx"/>';
	}
