							...
							<tr>
								<td height="300" align="left" valign="top">
									...
									<table width="700" align="center" cellspacing="5">
										<s:form action="saveperson" method="post" id="addOnlineqaForm"
												...
												<td width="332">
													<label>
														<input id="title" name="onlineqa.title" type="text"
															class="input" size="55"
															 onblur="javascript:char_valid1('title','role_name_mess',3,30,'标题',2);"/>
													</label>
												</td>
												<td width="272">
													<span class="mainred">
											...
											<tr>
												...
												<td>
													<textarea name="onlineqa.content" id="content" cols="53"
														rows="13"
														onblur="javascript:char_valid1('content','content_mess',3,30,'内容',2);"></textarea>
												</td>
												<td>
													<span class="mainred">
														<div id="content_mess">
