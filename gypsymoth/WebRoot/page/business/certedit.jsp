...
<script language="javascript" type="text/javascript">
	...
	{ 
	document.span2.style.display='none'; 
	}  
	
	function afterPrint() 
	{ 
	document.span2.style.display=''; 
	} 
</script>  
	...
	<body>
		...
		<table width="1002" border="0" cellpadding="2" cellspacing="3" class="tab"  style="width:690px;">
			  ...
			  <tr>
			    <td height="40">&nbsp;</td>
			    <td valign="top" class="namber_date" style="padding-top:4px;">${appdate_view }</td>
			  </tr>
			</table>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
			  ...
			  <tr>
			    <td align="center">&nbsp;</td>
			    <td valign="top" class="ht11">Port of inspection and place of pier</td>
			    <td valign="top">:</td>
			    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			        <tr>
			          <td class="ht10"> &nbsp;${port_view }</td>
			        </tr>
			        <tr>
			          <td height="1" bgcolor="#000000"></td>
			        </tr>
			  ...
			  <tr>
			    <td align="center">&nbsp;</td>
			    <td valign="top" class="ht11">Port of destination</td>
			    <td valign="top">:</td>
			    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			        <tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tab">
			  <tr>
			    <td height="102" width="80%" align="right" valign="bottom">
			     &nbsp;
			     <table> 
			     	<tr> <td> 证书流水号:	</td>
			  ...
			  <tr>
			    <td height="102" colspan="2" align="center" valign="bottom"> 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" height="48">
			<tr>
				...
				<td height="38" align="left">	
					<input name="input" class="button" type="reset" value="返 回"
