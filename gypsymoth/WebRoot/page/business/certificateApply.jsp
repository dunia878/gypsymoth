...
<script language="javascript" type="text/javascript">
	...
	<body>
		...
		<table width="1002" border="0" cellpadding="2" cellspacing="3" class="tab"  style="width:740px;">
			  <tr>
			    <td  width="83%" height="92" valign="bottom">&nbsp;</td>
			    <td width="17%" valign="bottom" class="namber_no"> ${appno_view }  </td>
		  </tr>
			  <tr>
			    <td height="40">&nbsp;</td>
