...
document.form1.action="updataLink1.action";
// document.form1.action="updataLinkus.action";
// document.form1.action="deleteLinkusById1.action";
									...
									<td height="300" align="left" valign="top">
										...
										<!-- 
											...
											<tr>
												...
												<td align="center">
													<h5>
														<font color="#2894FF"><s:property value="linkus.linkusname" /></font>
													</h5>
												</td>
