...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 function gotoSubmit(){
   ...
   function jump(){
  	window.location="${pageContext.request.contextPath}/page/bulletin/getLinkusByType.action";
}
  </script>
	<body >
		<s:form action="saveLinkus" enctype="multipart/form-data" method="post">
			...
			<input type="hidden" name="linkusid" id="linkusid"
				...
				<tr>
					...
					<td valign="top" class="right">
						...
						<strong><s:text name="检验公司(总部)" /></strong>						</div>
