...
function jump(){
	window.location="${pageContext.request.contextPath}/page/organization/getOrganizationPre.action?orgId="+<%String orgId=request.getParameter("orgId"); out.println(orgId);%>;
}
</script>  
</head>
<body>
