				...
				<div class="dtree">
					...
					<!--
				    	...
				    	<s:iterator value="#request.selectOrgList" status="stat">
							selectorg.add('<s:property value='id'/>','<s:property value='parentId'/>','<s:property value='orgName'/>',"javascript:coor_click('<s:property value='orgName'/>','<s:property value='id'/>');");
				    	</s:iterator>
				    	</s:if>
