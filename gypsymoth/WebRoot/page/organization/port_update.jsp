...
<s:form action="updatePort" theme="simple" id="updatePort" enctype ="multipart/form-data" method="post">
  <tr>
    <td class="list_r">&nbsp;</td>
    <td valign="top" class="right"><div class="title"><s:text name="local" />： <s:text name="home" /> &gt;&gt; <s:text name="orgAndPerson" /> &gt;&gt; <strong><s:text name="updateport" /></strong></div>
      <div>
            ...
            <td height="300" align="left" valign="top"><!--编辑开始-->
                  <table width="706" align="center" cellspacing="5">
                     <tr>
                      ...
                      <td><input name="pId" type="text" class="input"   value="<s:property value="#request.list.PORT_ID"/>" size="55" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20"><s:text name="ChineseName"/></td>
                      <td><input name="portname" type="text" class="input"   value="<s:property value="#request.list.PORT_NAME"/>" size="55" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20"><s:text name="EnglishName"/></td>
                      <td><input name="portsname" type="text" class="input"   value="<s:property value="#request.list.PORT_SNAME"/>" size="55" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td height="38" align="left">
                      	   <input name="submit" class="button" type="submit" value="<s:text name="savebutton" />"/>
