...
<table border="0" cellspacing="0" cellpadding="0" class="contenttab">
  <tr>
    ...
    <td valign="top" class="right"><div class="title"></div>
      <div>
        <div class="success">
          <div class="errtext">重置密码成功!<br />
            	请尽快登录系统 [<a href="${pageContext.request.contextPath}/index.jsp"><span style="color:#FF0000"><s:text name="return"/></span></a>] <s:text name="主页"/>,修改您的初始密码。</div>
        </div>
      </div></td>
  </tr>
</table>
