...
一级公司 <s:select list="#request.firstOrgList" name="parentId" 
		id="parentId" listKey="ORG4" listValue="ORG_NAME" headerKey="-1" headerValue="-请选择-" onchange="javascript:ajaxselect('getSecondOrgListChargesStat.action','parentId','secondOrgDiv');">
</s:select>
</s:if>
<s:elseif test="#request.firstOrgList.size==0">
一级公司 <s:select list="#request.firstOrgList" name="parentId" 
		id="parentId" listKey="ORG4" listValue="ORG_NAME" headerKey="-1" headerValue="-请选择-">
	</s:select>
</s:elseif>
</s:if>
...
二级公司 <s:select list="#request.secondOrgList" name="orgId" 
		id="orgId" listKey="ORG4" listValue="ORG_NAME" headerKey="-1" headerValue="-请选择-" onchange="javascript:ajaxselect('getPortListChargesStat.action','orgId','portDiv');">
</s:select>
</s:if>
<s:elseif test="#request.secondOrgList.size==0">
二级公司 <s:select list="#request.secondOrgList" name="orgId" 
		id="orgId" listKey="ORG4" listValue="ORG_NAME" headerKey="-1" headerValue="-请选择-">
	</s:select>
</s:elseif>
</s:elseif>
