		...
		<table border="0" cellspacing="0" cellpadding="0" class="contenttab">
			<tr>
				...
				<td valign="top" class="right">
					...
					<div>
					<s:form theme="simple" method="post" action="getExcelByLedgerStatOrg"
								...
								<td>
									<div class="tableContent">
										<table width="100%" border="0" cellspacing="1" cellpadding="0">
											...
											<tr>
												<td align="center">
													<c:if test="${ORGNAME=='检'}">检验公司</c:if><c:if test="${ORGNAME!='检'}">${ORGNAME }</c:if>
													<input type="hidden" name="hidden_body" value="${ORGNAME }" />
												</td>
												<td align="center">
													${ONENAME }
												...
												<td align="center">
													${ONEMONEY }
													<input type="hidden" name="hidden_body" value="${ONEMONEY }" />
												</td>
												<td align="center">
													${TWONAME }
												...
												<td align="center">
													${TWOMONEY }
													<input type="hidden" name="hidden_body" value="${TWOMONEY }" />
												</td>
												<td align="center">
													${THREENAME }
												...
												<td align="center">
													${THREEMONEY }
													<input type="hidden" name="hidden_body" value="${THREEMONEY }" />
												</td>
												<td align="center">
													${TOTAL }
