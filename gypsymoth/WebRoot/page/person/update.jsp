...
function deleteperson(){ 
	...
	document.forms[0].method="post";
 	document.forms[0].action ="${pageContext.request.contextPath}/page/person/delete.action?id="+pid ;
        ...
        <table align="center" cellpadding="12" class="tabedit">
          ...
          <tr>
            <td height="300" align="left" valign="top"><!--编辑开始-->
                ...
                <td width="332"><label>
                        <input name="name" id="name" type="text" class="input"  value="<s:property value="#request.list.NAME"/>" size="55" />
                      </label></td>
                      <td width="272">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <td width="332"><label>
                      <input name="spell" id="spell" type="text" class="input" id="spell" size="55" value="<s:property value="#request.list.SPELL"/>"/>
                    </label></td>
                    <td width="272">&nbsp;</td>
                  </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input name="birthday" id="birthday" type="text" class="input"  value="<s:property value="#request.list.BIRTHDAY"/>" size="55" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20"><s:text name="education"/></td>
                      <td><input name="education" id="education" type="text" class="input"  value="<s:property value="#request.list.EDUCATION"/>" size="55" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    ...
                    <td height="20"><s:text name="belongCompany"/></td>
                     <td> 
                     <input id="selectOrgname2" name="selectOrgname2" type="text" size="43"  value="${selectOrgname}"/>
							                <input type="button" class="button" onclick="selectOrgTree()" value="<s:text name="choose"/>" />* </td>
                    <td>&nbsp;</td>
                  </tr>
                    <tr>
                    	<td height="20"><s:text name="personType"/></td>
                    	<td><select name="personType" id="personType" style="width:305px;">
                    ...
                    <tr>
                      ...
                      <td>
                      <input name="training" type="checkbox" id="training" <s:if test="#request.list.TRAINING==1">checked="checked"</s:if>  value="<s:property value="#request.list.TRAINING"/>"/>
					</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td><input name="passTime" id="passTime" type="text" class="input" size="55" value="<s:property value="#request.list.PASS_TIME"/>" onClick="WdatePicker()"/></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20"><s:text name="isCoordinator"/></td>
                      <td>
                      <input name="isCoordinator" id="isCoordinator" type="checkbox" id="checkbox2" <s:if test="#request.list.IS_COORDINATOR==1">checked="checked"</s:if>  value="<s:property value="#request.list.IS_COORDINATOR"/>"/>
						</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                      <input name="isAuthorized" id="isAuthorized" type="checkbox" id="checkbox3" <s:if test="#request.list.IS_AUTHORIZED==1">checked="checked"</s:if>  value="<s:property value="#request.list.IS_AUTHORIZED"/>"/>
						</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td><input type="file" name="attachment" id="attachment" size="42"/></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20"><s:text name="isInspector"/></td>
                      <td>
                      <input name="isInspector" type="checkbox" id="isInspector" <s:if test="#request.list.IS_INSPECTOR==1">checked="checked"</s:if>  value="<s:property value="#request.list.IS_INSPECTOR"/>"/>
					  </td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="38" align="left"><input type="hidden" id="id" name="id" value="<s:property value="#request.list.ID"/>"/></td>
                      <td height="38" align="left">
                      <c:forEach items="${menu_parent}" var="mp3" varStatus="status">
                      <c:if test="${mp3.rightId == 322}">
                      <input name="input" class="button" type="submit"  value="<s:text name="update"/>" onclick="return addsubmit();"/>
                      </c:if>
                      </c:forEach>
