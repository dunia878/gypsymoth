...
<link rel=stylesheet href="${pageContext.request.contextPath}/style/right.css" type="text/css" />
 ...
 function updateperson(){
 	...
 	document.forms[0].action ="${pageContext.request.contextPath}/page/person/getUpdateInfo.action" ;
...
<table border="0" cellspacing="0" cellpadding="0" class="contenttab">
  <tr>
    <td class="list_r">&nbsp;</td>
    <td valign="top" class="right"><div class="title"><s:text name="local"/>： <s:text name="home"/> &gt;&gt; <s:text name="SystemManage"/> &gt;&gt; <strong><s:text name="basicInfo"/></strong></div>
      <div>
