...
function save(){
        	...
        	if(coEnName==""){
   				document.getElementById("name_mess1").innerHTML="<s:text name='coEnName_error'/>";
   				document.getElementById("coEnName").focus();
   				return false;
   			}
   			// else if(!formatName.test(coEnName)){
   		      //   document.getElementById("name_mess1").innerHTML="公司英文名不能含有空格!";
   			  //   return false;
   		 //   }
        	...
        	if(tel==""){
   				document.getElementById("tel_mess1").innerHTML="<s:text name='tel_error1'/>";
   				document.getElementById("tel").focus();
   				return false;
   			}
   			var email = document.getElementById("email").value;
        	if(email==""){
   				document.getElementById("email_mess1").innerHTML="<s:text name='email_error1'/>";
   				document.getElementById("email").focus();
   				return false;
   			}
   			var onePersonName = document.getElementById("onePersonName").value;
        	if(onePersonName==""){
   				document.getElementById("onePersonName_mess1").innerHTML="<s:text name='PersonName_error1'/>";
   				document.getElementById("onePersonName").focus();
   				return false;
   			}
   			var registerEmail = document.getElementById("registerEmail").value;
        	if(registerEmail==""){
   				document.getElementById("registerEmail_mess1").innerHTML="<s:text name='email_error1'/>";
		...
		<table border="0" cellspacing="0" cellpadding="0" class="contenttab">
			<tr>
				...
				<td valign="top" class="right">
					<div class="title"><s:text name="您的当前位置"/>： <s:text name="首页"/> &gt;&gt; <s:text name="系统管理"/> &gt;&gt; <strong><s:text name="基本信息修改"/></strong>
										...
										<s:form theme="simple" method="post" action="updataClientS" id="form1"
												...
												<td align="left">
													<label>
														<select name="client.coProperty" id="client.coProperty"
															...
															<option value="国有" <s:if test="client.coProperty=='国有'">selected="selected"</s:if>>
																<s:text name="国有"/>
															</option>
															<option value="合作" <s:if test="client.coProperty=='合作'">selected="selected"</s:if>>
																<s:text name="合作"/>
															</option>
															<option value="合资" <s:if test="client.coProperty=='合资'">selected="selected"</s:if>>
																<s:text name="合资"/>
															</option>
															<option value="外商独资" <s:if test="client.coProperty=='外商独资'">selected="selected"</s:if>>
																<s:text name="外商独资"/>
															</option>
															<option value="集体" <s:if test="client.coProperty=='集体'">selected="selected"</s:if>>
																<s:text name="集体"/>
															</option>
															<option value="私营" <s:if test="client.coProperty=='私营'">selected="selected"</s:if>>
																<s:text name="私营"/>
															</option>
														</select>
													</label>
											...
											<tr>
												...
												<td align="left">
													...
													<div id="addressdiv1" <s:if test="NATIONID!=37">style="display: none"</s:if> >
														<table>
															<tr>
																<td>
													...
													<div id="addressdiv2" <s:if test="NATIONID==37">style="display: none"</s:if> >
														<table>
															<tr>
																<td align="left">
																	<s:if test="#session.WW_TRANS_I18N_LOCALE!=null && #session.WW_TRANS_I18N_LOCALE.toString()=='en_US'">
																		...
																		listKey="NATIONID" listValue="NATION_EN_NAME"
																		headerKey="0" headerValue="-%{getText('请选择')}-"></s:select>
																	</s:if>
																	<s:else>
																		<s:select list="#request.nationList"
																		name="client.nationId" id="client.nationId"
																		listKey="NATIONID" listValue="NATION_CN_NAME"
																		headerKey="0" headerValue="-%{getText('请选择')}-"></s:select>
																	</s:else>
																	<s:text name="国" />
																</td>
											...
											<tr>
												...
												<td height="38" align="left">
													<input name="input1" class="button" type="button"
														onclick="save()" value="<s:text name='save'/>" />
