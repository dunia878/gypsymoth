											...
											<tr>
												...
												<td align="left">
													<input id="client.coProperty"
														...
														size="55" disabled="disabled"
														value="<s:text name="%{client.coProperty}"/>" />
												</td>
											</tr>
											<tr>
												<td height="20" align="left">
											...
											<tr>
												...
												<td align="left">
													<input disabled="disabled" id="client.address"
														...
														value="<s:if test="#session.WW_TRANS_I18N_LOCALE!=null && #session.WW_TRANS_I18N_LOCALE.toString()=='en_US'"><s:property value="nat.nationEnName"/></s:if><s:else><s:property value="nat.nationCnName"/></s:else><s:text name="%{promary.proname}"/> <s:text name="%{cityname}"/> <s:property value="client.address"/>" />
												</td>
											</tr>
